...
class Nut implements \Countable, \IteratorAggregate
{
   ...
   */
  public function execute($sql, $isSave = false)
  {
    $params = $isSave ? (array) $this->property : $this->parameter;
  ...
  {
    $this->select("*")->order('created_at', true);
    ...
    $this->property = $this->db->count() === 1 ? [$this->property] : $this->property;
